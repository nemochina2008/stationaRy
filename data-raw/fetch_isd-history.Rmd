...
Create the `corrected_elev` object and tidy up by converting any factors to
character prior to performing a left-join with the `stations` object.
...
The `isd_history.rda` file is bundled in the package and includes the new
